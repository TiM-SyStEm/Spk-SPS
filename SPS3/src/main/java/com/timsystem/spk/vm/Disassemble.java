        ...
        for (int i = 0; i < bytes.size(); i++) {
            ...
            switch (instruction) {
                ...
                case Instructions.OP_EDIT_VAR -> {
                    ...
                    i += 4;
                    constantInstruction("OP_EDIT_VAR", bytecode, IntegerBytesConvert.byteArr2Int(indexBytes));
                }
                case Instructions.OP_DEL_VAR -> {
                    ...
                    i += 4;
                    constantInstruction("OP_DEL_VAR", bytecode, IntegerBytesConvert.byteArr2Int(indexBytes));
                }
                default -> {
